...
The material in this document is either adapted of simply borrowed from the freely accessible book [Happy Git and GitHub for the useR](https://happygitwithr.com) by  Jennifer Bryan.
...
The sequence of clicking steps above can be implemented alternatively in a two lines of R code:
