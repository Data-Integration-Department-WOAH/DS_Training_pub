...
The present page is a guide for working with git and github from Rstudio[^1]

[^1]: Most of the material in this page is borrowed from the freely accessible book [Happy Git and GitHub for the useR](https://happygitwithr.com) by Jennifer Bryan.

To work collaboratively with git under Rstudio, you will need to go through account set up, software installation and credential setting.
