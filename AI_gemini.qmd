...
author: "Your Friendly Data Science Professor"
format: 
  html:
    toc: true
    toc-location: left
...
## Welcome, Aspiring Cartographers!
...
## 2. The Secret Sauce: Coordinate Reference Systems (CRS)
...
![An image showing the globe (a 3D sphere) being "unwrapped" or projected onto a flat 2D map, which inevitably causes some distortion.](https://i.imgur.com/FbbN59c.png)
...
## 3. Setting Up Your RStudio Workshop
...
## 4. Your First Map: Working with Vector Data
...
## 5. Painting with Pixels: Working with Raster Data
...
## 6. The Grand Finale: Combining Vector and Raster
