...
# Part I: Intro to Rstudio


## Where to ask questions?

-   `Teams -> Data Science Training ->  Chat Training Summer-Autumn 2025` 
...
# Part II: Basic syntax and vocabulary for data wrangling and graphics
...
- Write instructions based on `filter, arrange, select, mutate` respectively.
- Create a simple and nice looking scatter plot.
